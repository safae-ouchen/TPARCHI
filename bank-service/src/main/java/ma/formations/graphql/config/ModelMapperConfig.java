...
public class ModelMapperConfig {
    ...
    public ModelMapper modelMapper() {
        ...
        modelMapper.getConfiguration().
                ...
                setFieldAccessLevel(org.modelmapper.config.Configuration.AccessLevel.PRIVATE);Converter<Date, String> dateToStringConverter = new AbstractConverter<>() {
            @Override
        ...
        Converter<String, Date> stringToDateConverter = new AbstractConverter<>() {
            ...
            public Date convert(String s) {
                try {return tools.stringToDate(s);
